...
Kangaroo::Kangaroo(Secp256K1 *secp, int32_t initDPSize, bool useGpu, string &workFile, string &iWorkFile, 
                   ...
                   string outputFile, bool splitWorkfile, int startingKeyIdx) {
...
void Kangaroo::Run(int nbThread, std::vector<int> gpuId, std::vector<int> gridSize) {
  ...
  for(; keyIdx < keysToSearch.size(); keyIdx++) {
